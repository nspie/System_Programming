...
public class ReactorServer<T> {
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        final BGUNonBlockingConnectionHandler<T> handler = new BGUNonBlockingConnectionHandler<T>(
                readerFactory.get(),
                protocolFactory.get(),
                clientChan,
                this, connections);
    ...
    private void handleReadWrite(SelectionKey key) {
        ...
        BGUNonBlockingConnectionHandler<T> handler = (BGUNonBlockingConnectionHandler<T>) key.attachment();
        if (key.isReadable()) {
